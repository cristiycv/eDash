...
class CZCPaymentAddress : public CZCEncoding<libedash::PaymentAddress, CChainParams::ZCPAYMENT_ADDRRESS, libedash::SerializedPaymentAddressSize> {
protected:
...
public:
    ...
    CZCPaymentAddress(const libedash::PaymentAddress& addr) { Set(addr); }
};

class CZCViewingKey : public CZCEncoding<libedash::ViewingKey, CChainParams::ZCVIEWING_KEY, libedash::SerializedViewingKeySize> {
protected:
...
public:
    ...
    CZCViewingKey(const libedash::ViewingKey& vk) { Set(vk); }
};

class CZCSpendingKey : public CZCEncoding<libedash::SpendingKey, CChainParams::ZCSPENDING_KEY, libedash::SerializedSpendingKeySize> {
protected:
...
public:
    ...
    CZCSpendingKey(const libedash::SpendingKey& addr) { Set(addr); }
};

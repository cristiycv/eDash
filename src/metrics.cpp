...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your edash.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
        ...
        CAmount mature {0};
        {
            ...
            while (it != u->end()) {
                ...
                if (mapBlockIndex.count(hash) > 0 &&
                    ...
                    if ((height > 0) && (height <= consensusParams.GetLastCommunityRewardBlockHeight())) {
                        subsidy -= subsidy/5;
                    }
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("edash-metrics-screen");
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << _("Thank you for running a edash node!") << std::endl;

...
BOOST_AUTO_TEST_CASE(rpc_wallet_z_importwallet)
{
    ...
    auto testSpendingKey = libedash::SpendingKey::random();
    ...
    std::string format_str = "# Wallet dump created by edash v0.11.2.0.z8-9155cc6-dirty (2016-08-11 11:37:00 -0700)\n"

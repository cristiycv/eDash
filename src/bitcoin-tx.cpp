...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("edash edash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  edash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded edash transaction") + "\n" +
              "  edash-tx [options] -create [commands]   " + _("Create hex-encoded edash transaction") + "\n" +
              "\n";

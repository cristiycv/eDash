...
./edashd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.nID           = 1004;  // use https://github.com/edash/edash/wiki/specification#assigned-numbers to keep track of alert IDs
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client version 1.0.10 has degraded networking behavior. Please update to the most recent version of edash (1.0.10-1 or later).";
    alert.strRPCError   = alert.strStatusBar;

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MagicBean:0.7.2/"));
    const std::vector<std::string> useragents = {"MagicBean", "BeanStalk", "AppleSeed", "Eleosedash"};

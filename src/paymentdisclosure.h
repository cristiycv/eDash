...
#ifndef edash_PAYMENTDISCLOSURE_H
#define edash_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // edash/NoteEncryption.cpp
    ...
    PaymentDisclosureInfo(uint8_t v, uint256 esk, uint256 key, libedash::PaymentAddress zaddr) : version(v), esk(esk), joinSplitPrivKey(key), zaddr(zaddr) { }
...
struct PaymentDisclosurePayload {
    ...
    libedash::PaymentAddress zaddr; // edash/Address.hpp
...
#endif // edash_PAYMENTDISCLOSURE_H

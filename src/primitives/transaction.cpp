...
JSDescription::JSDescription(ZCJoinSplit& params,
            ...
            const boost::array<libedash::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libedash::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
            bool computeProof,
...
{
    boost::array<libedash::Note, ZC_NUM_JS_OUTPUTS> notes;

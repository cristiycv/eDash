...
const unsigned char edash_PREVOUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','P','r','e','v','o','u','t','H','a','s','h'};
const unsigned char edash_SEQUENCE_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','S','e','q','u','e','n','c','H','a','s','h'};
const unsigned char edash_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','O','u','t','p','u','t','s','H','a','s','h'};
const unsigned char edash_JOINSPLITS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','J','S','p','l','i','t','s','H','a','s','h'};

uint256 GetPrevoutHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, edash_PREVOUTS_HASH_PERSONALIZATION);
...
uint256 GetSequenceHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, edash_SEQUENCE_HASH_PERSONALIZATION);
    for (unsigned int n = 0; n < txTo.vin.size(); n++) {
...
uint256 GetOutputsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, edash_OUTPUTS_HASH_PERSONALIZATION);
...
uint256 GetJoinSplitsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, edash_JOINSPLITS_HASH_PERSONALIZATION);
    ...
    const PrecomputedTransactionData* cache)
{
    ...
    if (sigversion == SIGVERSION_OVERWINTER) {
        ...
        memcpy(personalization, "edashSigHash", 12);

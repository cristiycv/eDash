...
Simon (21):
      ...
      Use -O1 opimitization flag when building libedash. Continuation of #1064 and related to #1168.
      Add test for non-malleable txids.  To run just this test: ./edash-gtest --gtest_filter="txid_tests*"
...
Taylor Hornby (8):
      ...
      Put hardened stuff in libedash CPPFLAGS.

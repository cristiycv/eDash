...
bitcartel (15):
      ...
      Update URL for edash alert IDs.
...
Taylor Hornby (17):
      ...
      Rename zerocash to edash in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/edash in Makefile.am
      Rename zerocash_packages to edash_packages in packages.mk

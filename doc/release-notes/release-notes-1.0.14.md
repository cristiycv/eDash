...
[the edash protocol spec](https://github.com/edash/zips/blob/master/protocol/protocol.pdf),
...
- **Caution:** for z-addresses, these balances will **not** be accurate if any
  ...
  (e.g. [#2542](https://github.com/edash/edash/issues/2542)).
...
Jack Grigg (40):
      ...
      build: Split hardening/fPIE options out in edash-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move edash flags into configure.ac
      ViewingKey -> ReceivingKey per edash/zips#117
      ...
      Add watch-only support to edash RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to edash and not bitcoin.

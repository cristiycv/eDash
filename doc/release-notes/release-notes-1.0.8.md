...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to edashd by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for edashd -help.
...
Jay Graber (5):
      ...
      Add security warning to edash-cli --help and --version message output
      Add security warning to edashd metrics display
...
Sean Bowe (2):
      Introduce librustedash and Rust to depends system.

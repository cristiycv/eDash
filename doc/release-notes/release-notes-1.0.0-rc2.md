...
Jack Grigg (31):
      ...
      Rename libbitcoinconsensus to libedashconsensus
      Rename bitcoin-tx to edash-tx
...
Jay Graber (7):
      Rm bitcoin dev keys from gitian-downloader, add edash dev keys
      Rm bips.md
      Update files.md for edash

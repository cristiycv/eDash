...
Alfie John (1):
      Rename libzerocash to libedash
...
Jack Grigg (21):
      ...
      Add edash revision to version strings
      Bitcoin -> edash in version and help text
      Add edash Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-edash`` correctly runs the ``edash-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the edash build.

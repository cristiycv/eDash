...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "edash" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pedashParams with private member variable
      Revert "Reduce use of global pedashParams with private member variable"
      Replace edashParams_ with global.

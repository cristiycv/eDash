...
edash has been subjected to a formal third-party security review. For security
...
This implementation of edash is not resistant to side-channel attacks. You
should assume (even unprivileged) users who are running on the hardware, or who
are physically near the hardware, that your `edashd` process is running on will
be able to:
...
unprivileged) on the hardware your `edashd` process runs on until these
...
in [issue #826](https://github.com/edash/edash/issues/826), and believe that we

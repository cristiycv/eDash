...
This is an experimental feature.  Enable it by launching `edashd` with flags:

    edashd -experimentalfeatures -paymentdisclosure -debug=paymentdisclosure -txindex=1

These flags can also be set as options in `edash.conf`.
...
[1] https://github.com/edash/zips/pull/119
...
Generate a payment disclosure for the first joinsplit, second output (index starts from zero):
    ...
    edash-cli z_getpaymentdisclosure 79189528d611e811a1c7bb0358dd31343033d14b4c1e998d7c4799c40f8b652b 0 1 "Hello"
...
To validate the payment disclosure:
    ...
    edash-cli z_validatepaymentdisclosure HEXDATA

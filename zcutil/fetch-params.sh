...
Failed to fetch the edash zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
edash - fetch-params.sh

This script will fetch the edash zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common edash zkSNARK parameters. Note that it is
